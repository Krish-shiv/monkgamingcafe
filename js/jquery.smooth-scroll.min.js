!function(t) {
        ...
        smoothScroll: function(l, o) {
            ...
            return this.unbind("click.smoothscroll").bind("click.smoothscroll", function(l) {
                var o = this
                  ...
                  , m = i.scrollTarget || (t.smoothScroll.filterPath(o.pathname) || s) === s
                  , S = e(o.hash);
    ...
    t.smoothScroll = function(e, l) {
        if ("options" === e && "object" == typeof l)
            return t.extend(o, l);
        var n, s, r, i, c = 0, a = "offset", f = "scrollTop", h = {}, u = {};
        ...
        /^(?:HTML|BODY)$/.test(s[0].nodeName) || (c = s[f]())) : s = t("html, body").firstScrollable(n.direction),
        n.beforeScroll.call(s, n),
        r = "number" == typeof e ? e : l || t(n.scrollTarget)[a]() && t(n.scrollTarget)[a]()[n.direction] || 0,
        h[f] = r + c + n.offset,
        i = n.speed,
        "auto" === i && (i = h[f] || s.scrollTop(),
        i /= n.autoCoefficent),
        u = {
            duration: i,
            easing: n.easing,
